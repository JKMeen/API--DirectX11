...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd) {
	...
	result = InitializeShader(device, hwnd, 
		L"C:/Users/cho/Documents/Visual Studio 2013/Projects/17-2-DirextX11 Test/02. 프레임워크와 윈도우 만들기/color.vs", 
		L"C:/Users/cho/Documents/Visual Studio 2013/Projects/17-2-DirextX11 Test/02. 프레임워크와 윈도우 만들기/color.ps"); 
	if(!result) { 
		return false; 
	} 
